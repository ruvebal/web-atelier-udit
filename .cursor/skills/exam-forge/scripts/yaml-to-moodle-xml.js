#!/usr/bin/env node
/**
 * YAML to Moodle XML Transformer (exam-forge)
 ...
 *
 * Uso:
 *   node yaml-to-moodle-xml.js --input=path/to/exam.yml --output=exam-moodle.xml
 *   npm run moodle -- --input=../exams/midterm.yml --output=midterm-moodle.xml
 *
 * Relative --input / --output paths resolve from process.cwd() first.
 *
...
const outputPath = resolveOutputPath(outputFile, scriptDir);
