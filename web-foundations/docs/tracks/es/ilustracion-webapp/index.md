...
- **Formación artística**: Estudiantes con background en ilustración, diseño gráfico o artes visuales
- **Interés digital**: Curiosidad por cómo sus habilidades creativas pueden aplicarse a medios interactivos
- **Nivel técnico**: Principiantes en programación, pero con disposición para aprender
- **Objetivos profesionales**: Interés en trabajar como diseñadores UX/UI, desarrolladores front-end creativos, o artistas digitales
...
- **Arquitectura de prompts** — Cómo comunicarte efectivamente con las herramientas de IA

> **Nota**: El uso de IA es opcional pero recomendado como herramienta de aprendizaje, no como sustituto del pensamiento crítico y la creatividad.
...
- **Dominar herramientas de desarrollo** y flujos de trabajo profesionales
- **Implementar diseños responsivos** que funcionen en múltiples dispositivos
- **Aplicar principios de accesibilidad** y usabilidad web
...
- **Construir un portafolio digital** que showcase sus habilidades técnicas y creativas
- **Colaborar en equipos de desarrollo** utilizando metodologías ágiles
...
### Sesión 1 — La web como lienzo + planteamiento del proyecto
...
### Sesión 2 — Galerías y layouts para tu arte (media + grids)
...
Canon recomendado (media e imágenes):
...
### Sesión 3 — Maquetación responsive + frameworks (Bootstrap/Tailwind)
...
- Evidencia por sesión:
  - S1: primer deploy + wireframe
  - S2: galería de imágenes con grid/layout
  - S3: responsive + componente/maquetación
  - S4: 1 interacción + test con pares + iteración
- 1 commit final por sesión (mínimo 4).

## 🧪 Evaluación (resumen)

- Componente técnico (40%): semántica, funcionamiento, responsive, accesibilidad.
- Componente creativo (40%): diseño visual, UX, innovación, narrativa.
- Componente procesual (20%): documentación, reflexión, colaboración, presentación.
