...
title: 'Readings'
lang: en
permalink: /readings/en/
---

<body>
	<div class="theme">
		<!-- Toggle checkbox for Sidebar -->
		<input type="checkbox" id="sidebar-toggle" hidden />
		<label class="sidebar-toggle-btn" for="sidebar-toggle">☰ TOC</label>
		<div class="grid">
			<!-- Sidebar TOC -->
			<aside class="toc">
				<h6>Table of Contents</h6>
				<ul>
					<li><a href="#theweb">The Web</a></li>
					<li><a href="#html">HTML</a></li>
					<li><a href="#pwa">PWAs</a></li>
					<li><a href="#networking">Networking</a></li>
					<li><a href="#apis">APIs</a></li>
					<li><a href="#responsiveness">Responsiveness</a></li>
					<li><a href="#versioncontrol">Version Control</a></li>
					<li><a href="https://www.zotero.org/groups/5649080/ruvebal-web/library" target="_blank">Bibliography</a></li>
				</ul>
			</aside>
			...
			<main>
				...
				<div class="parallax">
					...
					<div class="slides">
						<!--  Section -->
						<div class="slide grid-container" id="theweb" aria-label="First Parallax Section">
							<div class="collection-title">
								<h2 class="typewriter" id="typewriter-theweb">The Web</h2>
							</div>
    						...
    						<div class="fluid-columns">
    							<article>
    								...
    								<blockquote>
    									...
    									<figure>
    										<img
    											src="https://www.whatismyip.com/static/6c8b2ff91a63e448541800241d914a57/uri-vs-url.webp"
    											alt="What is a URI vs a URL"
    								...
    								<cite>
    									(
    									<a href="https://www.zotero.org/groups/5649080/ruvebal-web/items/V4IUSSHY/item-list" target="_blank">
    										Jacobs y Walsh 2004
    									</a>
    									)
    								</cite>
    								...
    								<cite>
    									(
    									<a
    										href="https://www.zotero.org/groups/5649080/ruvebal-web/search/Bhushan/titleCreatorYear/items/BPKVM6GD/attachment/ZCRCRJE4/reader"
    										target="_blank">
    										Debnath, &amp; Bhushan 2023
    									</a>
    									, p. 2)
    								</cite>
    								...
    								<figure>
    									<img
    										src="https://lh5.googleusercontent.com/3_0pLzWVs4WhNkvNdbXRcKfnLb6ESXqnqRHtvi5XKlD3t2W869M3K8eRCpkf_MMplqWYhoxLukSRLhTrF4lsQce507SuIdNNfbkib1keCi9tzdzh7jmk1KTrDHJEMpnQEarqZowNWWYI8tu5hA"
    										alt="Google API Diagram"
    										style="width: 100%; height: auto" />
    									<figcaption>
    										Source:
    										<a href="https://www.google.com/" target="_blank">Google API Diagram</a>
    									</figcaption>
    								</figure>
    							</article>
    							...
    							<article>
    								...
    								<cite>(Shklar &amp; Rosen 2012, p. 1.1)</cite>
    							</article>
    							...
    							<article>
    								...
    								<cite>(Shklar &amp; Rosen 2012, p. 1.4)</cite>

    								<figure>
    									<img
    										src="https://media.licdn.com/dms/image/D5612AQE9ugOv0MKi0w/article-cover_image-shrink_720_1280/0/1690083431823?e=2147483647&v=beta&t=-uT_OsETczmI38w29953QDjBapCcgVPw9Y4E_X0zqrY"
    										alt="Article Cover Image"
    										style="width: 100%; height: auto" />
    									<figcaption>
    										Source:
    										<a href="https://www.linkedin.com/" target="_blank">LinkedIn - Article Cover Image</a>
    									</figcaption>
    								</figure>
    								...
    								<blockquote>
    									<p>
    										...
    										for a web vehicle that would bridge the gap between professional, and semi-professional users, and consumers,
    										encouraging collaborative web interactions and network effects. This new generation of web business and
    										applications became known as Web 3.0.
    									</p>
    								</blockquote>
    								...
    								<blockquote>
    									...
    									<p>
    										However, there is no universally accepted definition of Web 3.0.Web 3.0 represents the tangible manifestation
    										of current technology trends moving towards a new level of maturity. These trends include the internet,
    										network computing, open technologies, open identities, intelligent networks, distributed databases,
    										intelligent applications, and more.
    									</p>
    								</blockquote>
    								<cite>(Cheng 2024, 17-18)</cite>
    							</article>

    							<article>
    								<h4>History of the World Wide Web</h4>
    								<blockquote>
    									<p>
    										...
    										that the first browser could run were simple plain-text pages with hyperlinks. In fact, those first web pages
    										are still online and available to view today.
    									</p>
    								</blockquote>
    								<cite>(Hume &amp; Osmani 2018, p. 27)</cite>
    							</article>
    							...
    							<article>
    								...
    								<blockquote>
    									<p>
    										...
    										meaning of data, facilitating more intelligent data processing and interaction. At its core, the Semantic Web
    										is based on the principles of annotating data with metadata that describe its meaning and relationships in a
    										machine-readable format. This metadata enables automated reasoning, inference, and integration of disparate
    										data sources, thereby enabling more sophisticated applications and services.
    									</p>
    								</blockquote>
    								<cite>(Ortiz-Rodriguez et al. 2024, pp. 12-13)</cite>

    								<figure>
    									<img
    										src="https://www.w3.org/2001/12/semweb-fin/current-vs-sw.png"
    										alt="Current Web vs Semantic Web Diagram"
    										style="width: 100%; height: auto" />
    									<figcaption>
    										Source:
    										<a href="https://www.w3.org/" target="_blank">W3C - Current Web vs Semantic Web Diagram</a>
    									</figcaption>
    								</figure>
    								...
    								<blockquote>
    									<p>
    										...
    										work and to develop systems that can support trusted interactions over the network. In this sense, the Web of
    										data enables developing vertical applications that may bring forward specific and sometimes highly
    										non-trivial use cases, focusing to provide solutions to problems of different industries, such as Health Care
    										and Life Sciences, eGovernment, and Energy, to mention but a few, in order to improve collaboration, research
    										and development, and innovation adoption through Semantic Web technology.
    									</p>
    								</blockquote>
    								<cite>(Alor-Hernández 2019, p. v)</cite>
    							</article>
    						</div>
    					</div>

    					<!--  Section -->
    					<div class="slide grid-container" id="html" aria-label="Third Parallax Section">
    						<div class="collection-title">
    							<h2>HTML</h2>
    						</div>
    						...
    						<div class="fluid-columns">
    							<article>
    								...
    								<figure>
    									<img
    										src="https://qph.cf2.quoracdn.net/main-qimg-d6669176601357c5b45e963dd938d30d-pjlq"
    										alt="Quora Image Example"
    										style="width: 100%; height: auto" />
    									<figcaption>
    										Source:
    										<a href="https://www.quora.com/" target="_blank">Quora - Image Example</a>
    									</figcaption>
    								</figure>
    								...
    								<blockquote>
    									<p>
    										...
    										wrote a document called “HTML Tags” in which he proposed fewer than two dozen elements that could be used for
    										writing web pages.
    									</p>
    								</blockquote>
    								...
    								<blockquote>
    									<p>
    										Sir Tim didn't come up with the idea of using tags consisting of words between angle brackets; those kinds of
    										tags already existed in the SGML (Standard Generalized Markup Language) format. Rather than inventing a new
    										standard, Sir Tim saw the benefit of building on top of what already existed—a trend that can still be seen
    										in the development of HTML5.
    									</p>
    								</blockquote>
    								<cite>(Keith 2016, 5-6)</cite>
    							</article>
    						</div>
    					</div>

    					<!--  Section -->
    					<div class="slide grid-container" id="pwa" aria-label="Fourth Parallax Section">
    						<div class="collection-title">
    							...
    							<article>
    								...
    								<blockquote>
    									<p>
    										...
    										act more like a native or mobile app when running on capable browsers. That's it, that's all that needs to be
    										said.
    									</p>
    								</blockquote>
    								<cite>(Wargo 2020, p. 18)</cite>

    								<figure>
    									<img
    										src="https://images.contentstack.io/v3/assets/bltb1a38d5d52a9d1a1/blt2a4948584af06782/65d73662dbbd5bc81f8c7945/14_pwa.png?width=544&auto=webp&format=pjpg&disable=upscale&quality=100&dpr=2"
    										alt="PWA Diagram"
    										style="width: 100%; height: auto" />
    									<figcaption>
    										Source:
    										<a href="https://www.contentstack.com/" target="_blank">Contentstack - PWA Diagram</a>
    									</figcaption>
    								</figure>

    								<blockquote>
    									<p>
    										What is a 'web application?' It is a client-server application that uses a web browser as its client program.
    									</p>
    								</blockquote>
    								<cite>(Shklar &amp; Rosen 2012, p. 1.3)</cite>
    								...
    								<blockquote>
    									...
    									<ul>
    										...
    										<li>Interactive with a feel like a native app's</li>
    								...
    								<cite>(Hume &amp; Osmani 2018, pp. 34-35)</cite>
    								...
    								<cite>(Hume &amp; Osmani 2018, pp. 24-25)</cite>

    								<figure>
    									<img
    										src="https://miro.medium.com/v2/resize:fit:786/format:webp/1*Dlr1sdN1idUXk9MKImD0Mw.png"
    										alt="GraphQL API Query Diagram"
    										style="width: 100%; height: auto" />
    									<figcaption>
    										Source:
    										<a href="https://medium.com/@yourhandle/graphql-a-paradigm-shift-in-api-querying" target="_blank">
    											Medium - GraphQL API Query Diagram
    										</a>
    									</figcaption>
    								</figure>
    							</article>
    					...
    					<!--  Section -->
    					<div class="slide grid-container" id="networking" aria-label="Fifth Parallax Section">
    						<div class="collection-title">
    							<h2>Networking</h2>
    						</div>
    						...
    						<div class="fluid-columns">
    							<article>
    								...
    								<cite>(Network Protocols Handbook 2007)</cite>

    								<blockquote>
    									<p><strong>The TCP/IP Protocol Suite</strong></p>
    									<p>
    										...
    										Defense. For more on the history of TCP/IP, see the sidebar, “The fascinating story of TCP/IP,” later in this
    										chapter. Currently, the Internet Engineering Task Force (IETF) manages the TCP/IP protocol suite.
    									</p>
    								</blockquote>
    								...
    								<blockquote>
    									<p>
    										...
    										protocols, including Ethernet, as well as other protocols, such as token ring and FDDI (an older standard for
    										fiber-optic networks). The application layer of the TCP/IP model corresponds to the upper three layers of the
    										OSI model — the session, presentation, and application layers. Many protocols can be used at this level. A
    										few of the most popular are HTTP, FTP, Telnet, SMTP, DNS, and SNMP.
    									</p>
    								</blockquote>
    								<cite>(Lowe 2021, p. 141)</cite>

    								<figure>
    									<img
    										src="https://www.simplilearn.com/ice9/free_resources_article_thumb/TCP_Model_7.png"
    										alt="TCP/IP Model Diagram"
    										style="width: 100%; height: auto" />
    									<figcaption>
    										Source:
    										<a href="https://www.simplilearn.com/tutorials/cyber-security-tutorial/what-is-tcp-ip-model" target="_blank">
    											Simplilearn - TCP/IP Model
    										</a>
    									</figcaption>
    								</figure>
    								...
    								<blockquote>
    									...
    									<figure>
    										<img src="./assets/images/web/tcpip.png" alt="The TCP/IP model" style="width: 100%; height: auto" />
    									</figure>
    								</blockquote>
    								<cite>(Tanenbaum, Feamster &amp; Wetherall 2021)</cite>
    							</article>
    							<article>
    								<h4>TCP/IP Clients and Ports</h4>
    								<blockquote>
    									<p>
    									...
    									<p><strong>How Do TCP/IP Clients and Servers Communicate with Each Other?</strong></p>
    									<p>
    								...
    								<cite>(Shklar y Rosen 2012)</cite>
    							</article>
    							<article>
    								<h4>HTTP</h4>
    								<figure>
    									<img
    										src="https://ducmanhphan.github.io/img/network-protocol/http-protocol/basic-http.png"
    										alt="Introduction to HTTP protocol"
    										style="width: 100%; height: auto" />
    									<figcaption>
    										Source:
    										<a href="https://ducmanhphan.github.io/2019-02-05-HTTP-protocol/" target="_blank">HTTP protocol</a>
    									</figcaption>
    								</figure>
    								<blockquote>
    									<p>
    										Understanding HTTP is critical to the design of advanced web applications. It is a prerequisite for utilizing
    										the full power of Internet technologies […] Knowledge of the inner workings of HTTP promotes reasoning from
    										first principles, and simplifies the daunting task of learning the rich variety of protocols and APIs that
    										depend on its features […] Each HTTP exchange consists of a single request and a single response.
    									</p>
    									...
    									<p><strong>Structure of HTTP messages</strong></p>
    									<p>
    									...
    									<p>
    										<strong><em>GET method</em></strong>
    									</p>
    									<p>
    									...
    									<p>
    										<strong><em>Processing HTTP Requests</em></strong>
    									</p>
    									<p>
    										The act of sending an HTTP request to a web server consists of three basic steps: constructing the HTTP
    										request (Request Generation module), establishing a connection (Networking module) across the Internet to the
    										target server or an intermediate proxy, and transmitting the request (Networking module) over the established
    										connection.
    									</p>
    									<p>
    										<strong><em>Processing HTTP Responses</em></strong>
    									</p>
    									<p>
    										An HTTP response message consists of a status line (containing the HTTP version, a three-digit status code,
    										and a brief human-readable explanation of the status code), a series of headers (one per line), a blank line,
    										and finally the body of the response.
    									</p>
    								</blockquote>
    								<cite>(Shklar y Rosen 2012, 3.6)</cite>
    								<figure>
    									<img
    										src="https://ducmanhphan.github.io/img/network-protocol/http-protocol/sample-http-response.png"
    										alt="HTTP Response Message"
    										style="width: 100%; height: auto" />
    									<figcaption>
    										Source:
    										<a href="https://ducmanhphan.github.io/2019-02-05-HTTP-protocol/" target="_blank">HTTP protocol</a>
    					...
    					<!--  Section -->
    					<div class="slide grid-container" id="apis" aria-label="Sixth Parallax Section">
    						<div class="collection-title">
    							<h2 class="typewriter" id="typewriter-api">Application Programming Interfaces</h2>
    						</div>

    						<div class="fluid-columns">
    							<article>
    								<h4>APIs and GraphQL</h4>
    								<blockquote>
    									<p>
    										In the dynamic landscape of modern web development, APIs (Application Programming Interfaces) play a pivotal
    										role, enabling seamless communication between different software components and services. […] As the backbone
    										of modern web applications, APIs are essential for connecting diverse systems, enabling developers to harness
    										the power of third-party services, and fostering interoperability. […] REST (Representational State Transfer)
    										is a fundamental architectural style that underpins many of the APIs that we interact with daily. The
    										client-server model is at the heart of REST, defining clear roles and responsibilities for both clients and
    										servers. APIs also encourage modularity, reusability, and collaboration among development teams. Rather than
    										building everything from scratch, developers can focus on their core competencies and utilize APIs to handle
    										specialized tasks such as payment processing, authentication, geolocation, and more.
    									</p>
    								</blockquote>
    								<cite>(Selvaraj 2024, pp. 1-4)</cite>

    								<figure>
    									<img
    										src="https://restfulapi.net/wp-content/uploads/what-is-rest-api.png"
    										alt="REST API Diagram"
    										style="width: 100%; height: auto" />
    									<figcaption>
    										Source:
    										<a href="https://restfulapi.net/" target="_blank">RESTful API - What is REST API</a>
    									</figcaption>
    								</figure>
    								...
    								<cite>(Selvaraj 2024, pp. 496-497)</cite>

    								<figure>
    									<img
    										src="https://d2908q01vomqb2.cloudfront.net/fc074d501302eb2b93e2554793fcaf50b3bf7291/2022/10/21/Fig1-how-graphql-works.png"
    										alt="How GraphQL Works Diagram"
    										style="width: 100%; height: auto" />
    									<figcaption>
    										Source:
    										<a href="https://aws.amazon.com/blogs/mobile/how-graphql-works/" target="_blank">AWS - How GraphQL Works</a>
    									</figcaption>
    								</figure>
    							</article>
    						</div>
    					...
    					<!--  Section -->
    					<div class="slide grid-container" id="responsiveness" aria-label="Sixth Parallax Section">
    						<div class="collection-title">
    						...
    						<div class="fluid-columns">
    							<article>
    								...
    								<cite>(Niederst Robbins 2018, 40)</cite>
    								...
    								<blockquote>
    									...
    									<p>The technique has three core components:</p>
    									<ul>
    										<li>
    								...
    								<cite>(Niederst Robbins 2018, 487)</cite>
    								...
    								<cite>(Frain 2022, 12)</cite>
    							</article>
    						</div>
    					</div>

    					<!--  Section -->
    					<div class="slide grid-container" id="versioncontrol" aria-label="Sixth Parallax Section">
    						<div class="collection-title">
    						...
    						<div class="fluid-columns">
    							<article>
    								...
    								<blockquote>
    									<p>
    										Git is a technology that can be used to track changes to a project and to help multiple people to collaborate
    										on a project. At a basic level, a project version controlled by Git consists of a folder with files in it,
    										and Git tracks the changes that are made to the files in the project. This allows you to save different
    										versions of the work you're doing, which is why we call Git a version control system.
    									</p>
    									<p>
    		...
    		<footer>
    			<nav class="navbar" aria-label="Footer Navigation">
    				<a href="https://github.com/ruvebal-udit/web-fundamentals" class="nav-icon" aria-label="GitHub Project Link">
    					<img src="../../assets/icons/fi-social-github.svg" alt="GitHub Project Link" />
    				</a>
    				<ul class="nav-items">
    					<li><a href="#" aria-label="Footer Home Link">Home</a></li>
    					<li><a href="#" aria-label="Footer About Link">About</a></li>
    					<li><a href="#" aria-label="Footer Contact Link">Contact</a></li>
    				</ul>
    			</nav>
    		</footer>
    	</div>
